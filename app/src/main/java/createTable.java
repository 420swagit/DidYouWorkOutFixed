...
public class createTable extends SQLiteOpenHelper {
    ...
    //reading the table and getting a contact
    ...
    public List<Workout> getAllWorkouts() {
        List<Workout> contactList = new ArrayList<Workout>();
        // Select All Query
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                workout.setQuantity(cursor.getString(2));
    ...
    public int updateWorkout(Workout workout) {
        ...
        ContentValues values = new ContentValues();
        values.put(KEY_NAME, workout.getName());
        values.put(KEY_PH_NO, workout.getQuantity());
    ...
    public int updateContact(Workout workout) {
        SQLiteDatabase db = this.getWritableDatabase();
